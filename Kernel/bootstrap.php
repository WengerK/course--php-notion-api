...
{
  return [
    'NOTION_WEBMARDI_DATABASE_ID' => $_ENV['NOTION_WEBMARDI_DATABASE_ID'],
    'NOTION_TOKEN' => $_ENV['NOTION_TOKEN'],
    'NOTION_VERSION' => $_ENV['NOTION_VERSION'],
  ];
}
...
{
  echo "<pre class='code'>", json_encode(json_decode($response), JSON_PRETTY_PRINT), '</pre>';
}
