...
/**
 * Example to perform Notion Datababse listing of the Webmardi database next event.
 */
...
<?php echo renderResponse('Webmardi Next Event from Notion Database', $response); ?>
